...
**Live Site:** [https://society-maintenance-tracker-azure.vercel.app/](https://society-maintenance-tracker-azure.vercel.app/)
...
- **Email Delivery**: Twilio SendGrid API
  > **Note regarding Email Delivery:** The email delivery feature is currently utilizing the Twilio SendGrid API on the free tier. As a result, emails sent from this application may be routed to the recipient's spam or junk folder. If you are expecting an email, please be sure to check your spam folder.
